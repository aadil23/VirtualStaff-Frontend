...
const empSignUp = () => {
  return (
    <div>
      <section className="signup-employer-bg loginbg contactbg privacypagebg aboutuspagebg internal-enterprise-banner-page">
        <div className="banner-text">
          <h2>SIGN UP - EMPLOYER</h2>
          <p>Create A Free Employer Account, Post A Job Today</p>
        </div>
      </section>
      <section className="signup-employer-card login-page-card contactmaincard">
            ...
            <div className="col-md-12 col-xl-12 col-lg-12 col-sm-12 col-xs-12">
              <div className="contactus-left-card">
                <div className="login-user-icon">
                  ...
                  <div className="login-heading">Employer Details</div>
                </div>
                <form>
