...
const userSignUp = () => {
  return (
    <div>
      <section className="signup-jobseeker-bg signup-employer-bg loginbg contactbg privacypagebg aboutuspagebg internal-enterprise-banner-page">
        <div className="banner-text">
          <h2>SIGN UP - JOBSEEKER</h2>
          <p>
            Online Jobs Philippines. Ready to Join Thousands of Filipinos who already have home
            based jobs in the Philippines?
          </p>
        </div>
      </section>
      <section className="signup-jobseeker-card signup-employer-card login-page-card contactmaincard">
            ...
            <div className="col-md-12 col-xl-12 col-lg-12 col-sm-12 col-xs-12">
              <div className="contactus-left-card">
                <div className="login-user-icon">
                  ...
                  <div className="login-heading">JobSeeker Details</div>
                </div>
                <form>
                  <div className="contactus-left-card-input form-group">
                    ...
                    >
                      <path
                        d="M9.71484 12C10.8658 12 11.7148 11.151 11.7148 10C11.7148 8.849 10.8658 8 9.71484 8C8.56384 8 7.71484 8.849 7.71484 10C7.71484 11.151 8.56284 12 9.71484 12Z"
                        fill="#004C70"
                      />
                      <path
                  ...
                  <div className="custom-signup-btn custom-login-btn custom-submit form-group">
                    <button className="primary-yellow-filled-btn">CREATE AN ACCOUNT</button>
                  </div>
                  <div className="terms-text">
                    By clicking the button you confirm that you accept the{' '}
